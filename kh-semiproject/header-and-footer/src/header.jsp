            ...
            <% if(session.getAttribute("id")==null) { %>
                <div class="header-align">
                    ...
                    <div class="btns-signin-signup">
                        ...
                        <span><a href="index.jsp?inc=view/signin/login.jsp" id="cart_before_login"><img
                ...
                <% } else { %>
                    <div class="header-align">
                        ...
                        <div class="btns-signin-signup">
                            ...
                            <span><a href="notice">고객센터</a></span>
                            <span><a href="cart"><img src="view/img/shoppingcart_white.png"
                                        id="shoppingcart"></a></span>
                        </div>
                    </div>
